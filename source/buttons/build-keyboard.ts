...
export async function buildKeyboard(content: (ButtonRow | KeyboardPartCreator)[], actionCodePrefix: string, ctx: TelegrafContext): Promise<InlineKeyboardMarkup> {
...
async function buildKeyboardRow(row: ButtonInfo[], actionCodePrefix: string, ctx: TelegrafContext): Promise<InlineKeyboardButton[]> {
